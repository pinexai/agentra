"""Multi-Agent Trust Exploitation Scanner — sentrix v0.2.0.
...
class SwarmScanReport:
    ...
    def _persist(self) -> None:
        ...
        try:
            ...
            print(f"[sentrix] Warning: could not persist swarm report: {e}")
        finally:
            conn.close()
    ...
    for attack_type in attacks:
        ...
        for i, payload in enumerate(payloads):
            ...
            try:
                ...
                print(f"[sentrix] Warning: swarm run error: {e}")

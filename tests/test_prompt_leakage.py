"""Tests for sentrix.guard.prompt_leakage — system prompt leakage scoring."""
import pytest


class TestLeakageReport:
    def _make_report(self, score=0.3):
        from sentrix.guard.prompt_leakage import LeakageReport
...
class TestPromptLeakageScore:
    ...
    def test_ngram_extraction(self):
        from sentrix.guard.prompt_leakage import _extract_ngrams
    ...
    def test_leakage_detection(self):
        from sentrix.guard.prompt_leakage import _check_leakage

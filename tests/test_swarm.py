"""Tests for sentrix.guard.swarm — multi-agent trust exploitation."""
import importlib
from unittest.mock import MagicMock, patch

import pytest

_swarm_mod = importlib.import_module("sentrix.guard.swarm")
...
class TestSwarmScanReport:
    ...
    def test_summary_runs(self, capsys):
        from sentrix.guard.swarm import SwarmScanReport
    ...
    def test_persist(self, tmp_db):
        ...
        from sentrix.db import set_db_path
        set_db_path(tmp_db)
        report._persist()

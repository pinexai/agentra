"""Tests for sentrix.guard.multilingual — cross-language safety bypass matrix."""
import importlib
from unittest.mock import MagicMock, patch

import pytest

_ml_mod = importlib.import_module("sentrix.guard.multilingual")
...
class TestMultilingualReport:
    def _make_report(self):
        from sentrix.guard.multilingual import MultilingualReport
...
class TestScanMultilingual:
    ...
    def test_mixed_language_attack_generated(self):
        from sentrix.guard.multilingual import _make_mixed_attack
